...
class WaypointUpdater(object):
    ...
    def waypoints_cb(self, waypoints):
        ...
        if not self.waypoints_2d:
            ...
            self.waypoint_tree = KDTree(self.waypoints_2d) #KDTree is a data structure that will allow us to look up the closest point in space really efficiently.
        self.loop()

    def traffic_cb(self, msg):
        # TODO: Callback for /traffic_waypoint message. Implement
        self.stopline_wp.idx = msg.data
